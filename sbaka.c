...
MODULE_DESCRIPTION("Very bad module, do not use any of its code in your work");
                 ...
                 unsigned int cmd, unsigned long arg)
{
	...
	case HDIO_GETGEO:
		 ...
		 * We set the start of data at sector four.
		 */
